...
<p><?php printf( _n( "Hi there. You've been sent a voucher!", "Hi there. You've been sent %d vouchers!", $voucher_count, WC_PDF_Product_Vouchers::TEXT_DOMAIN ), $voucher_count ); ?></p>

<?php if ( $message ) : ?>
	<p>&ldquo;<?php echo esc_html( $message ); ?>&rdquo;</p>
<?php endif; ?>

<p><?php echo _n( "You can find your voucher attached to this email", "You can find your vouchers attached to this email", $voucher_count, WC_PDF_Product_Vouchers::TEXT_DOMAIN ); ?></p>
